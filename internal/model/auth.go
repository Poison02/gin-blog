...
// GetMenuIdsByRoleId 通过角色id查询菜单id
...
// GetMenuListByUserId 根据 user_id 获取菜单列表
...
// GetResourceIdsByRoleId 通过角色id查询资源
...
// GetRoleIdsByUserId 通过用户id查询角色id集合
...
// GetUserAuthInfoById 通过id查找用户权限
